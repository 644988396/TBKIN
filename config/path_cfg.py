...
class Path:
    ...
    def proc_base_path(self, version_name):
        ...
        self.DATASET_ANNO_MAP = {
            ...
            'pt-coco': os.path.join(self.DATASET_PATHMAP['pt-coco'], 'pt_coco_annotations.json'),
            'pt-vg': os.path.join(self.DATASET_PATHMAP['pt-vg'], 'pt_vg_annotations.json'),
            'pt-conceptual': os.path.join(self.DATASET_PATHMAP['pt-conceptual'], 'pt_conceptual_annotations.json'),
            'pt-sbu': os.path.join(self.DATASET_PATHMAP['pt-sbu'], 'pt_sbu_annotations.json'),
            'pt-sbu': os.path.join(self.DATASET_PATHMAP['pt-sbu'], 'pt_sbu_annotations.json'),
        }
